...
import eload as el
import sload as sl
import rotshi as rot
import sbop as sb
import jump as jp
import cpu_ctrl as ctrl
import rotshi as rs
...
pointer = {
    ...
    0xF5: Opc('PUSH AF', 16,  sl.push_rr, ['A', 'F']),
...
cb_pointer = {
    ...
    0x58: Opc('BIT 3,B', 8, 2, mock),
    0x59: Opc('BIT 3,C', 8, 2, mock),
    0x5A: Opc('BIT 3,D', 8, 2, mock),
    0x5B: Opc('BIT 3,E', 8, 2, mock),
    0x5C: Opc('BIT 3,H', 8, 2, mock),
    0x5D: Opc('BIT 3,L', 8, 2, mock),
    0x5E: Opc('BIT 3,(HL)', 12, 2, mock),
    0x5F: Opc('BIT 3,A', 8, 2, mock),
    0x60: Opc('BIT 4,B', 8, 2, mock),
    0x61: Opc('BIT 4,C', 8, 2, mock),
    0x62: Opc('BIT 4,D', 8, 2, mock),
    0x63: Opc('BIT 4,E', 8, 2, mock),
    0x64: Opc('BIT 4,H', 8, 2, mock),
    0x65: Opc('BIT 4,L', 8, 2, mock),
    0x66: Opc('BIT 4,(HL)', 12, 2, mock),
    0x67: Opc('BIT 4,A', 8, 2, mock),
    0x68: Opc('BIT 5,B', 8, 2, mock),
    0x69: Opc('BIT 5,C', 8, 2, mock),
    0x6A: Opc('BIT 5,D', 8, 2, mock),
    0x6B: Opc('BIT 5,E', 8, 2, mock),
    0x6C: Opc('BIT 5,H', 8, 2, mock),
    0x6D: Opc('BIT 5,L', 8, 2, mock),
    0x6E: Opc('BIT 5,(HL)', 12, 2, mock),
    0x6F: Opc('BIT 5,A', 8, 2, mock),
    0x70: Opc('BIT 6,B', 8, 2, mock),
    0x71: Opc('BIT 6,C', 8, 2, mock),
    0x72: Opc('BIT 6,D', 8, 2, mock),
    0x73: Opc('BIT 6,E', 8, 2, mock),
    0x74: Opc('BIT 6,H', 8, 2, mock),
    0x75: Opc('BIT 6,L', 8, 2, mock),
    0x76: Opc('BIT 6,(HL)', 12, 2, mock),
    0x77: Opc('BIT 6,A', 8, 2, mock),
    0x78: Opc('BIT 7,B', 8, 2, mock),
    0x79: Opc('BIT 7,C', 8, 2, mock),
    0x7A: Opc('BIT 7,D', 8, 2, mock),
    0x7B: Opc('BIT 7,E', 8, 2, mock),
    0x7C: Opc('BIT 7,H', 8, 2, mock),
    0x7D: Opc('BIT 7,L', 8, 2, mock),
    0x7E: Opc('BIT 7,(HL)', 12, 2, mock),
    0x7F: Opc('BIT 7,A', 8, 2, mock),
    0x80: Opc('RES 0,B', 8, 2, mock),
    0x81: Opc('RES 0,C', 8, 2, mock),
    0x82: Opc('RES 0,D', 8, 2, mock),
    0x83: Opc('RES 0,E', 8, 2, mock),
    0x84: Opc('RES 0,H', 8, 2, mock),
    0x85: Opc('RES 0,L', 8, 2, mock),
    0x86: Opc('RES 0,(HL)', 16, 2, mock),
    0x87: Opc('RES 0,A', 8, 2, mock),
    0x88: Opc('RES 1,B', 8, 2, mock),
    0x89: Opc('RES 1,C', 8, 2, mock),
    0x8A: Opc('RES 1,D', 8, 2, mock),
    0x8B: Opc('RES 1,E', 8, 2, mock),
    0x8C: Opc('RES 1,H', 8, 2, mock),
    0x8D: Opc('RES 1,L', 8, 2, mock),
    0x8E: Opc('RES 1,(HL)', 16, 2, mock),
    0x8F: Opc('RES 1,A', 8, 2, mock),
    0x90: Opc('RES 2,B', 8, 2, mock),
    0x91: Opc('RES 2,C', 8, 2, mock),
    0x92: Opc('RES 2,D', 8, 2, mock),
    0x93: Opc('RES 2,E', 8, 2, mock),
    0x94: Opc('RES 2,H', 8, 2, mock),
    0x95: Opc('RES 2,L', 8, 2, mock),
    0x96: Opc('RES 2,(HL)', 16, 2, mock),
    0x97: Opc('RES 2,A', 8, 2, mock),
    0x98: Opc('RES 3,B', 8, 2, mock),
    0x99: Opc('RES 3,C', 8, 2, mock),
    0x9A: Opc('RES 3,D', 8, 2, mock),
    0x9B: Opc('RES 3,E', 8, 2, mock),
    0x9C: Opc('RES 3,H', 8, 2, mock),
    0x9D: Opc('RES 3,L', 8, 2, mock),
    0x9E: Opc('RES 3,(HL)', 16, 2, mock),
    0x9F: Opc('RES 3,A', 8, 2, mock),
    0xA0: Opc('RES 4,B', 8, 2, mock),
    0xA1: Opc('RES 4,C', 8, 2, mock),
    0xA2: Opc('RES 4,D', 8, 2, mock),
    0xA3: Opc('RES 4,E', 8, 2, mock),
    0xA4: Opc('RES 4,H', 8, 2, mock),
    0xA5: Opc('RES 4,L', 8, 2, mock),
    0xA6: Opc('RES 4,(HL)', 16, 2, mock),
    0xA7: Opc('RES 4,A', 8, 2, mock),
    0xA8: Opc('RES 5,B', 8, 2, mock),
    0xA9: Opc('RES 5,C', 8, 2, mock),
    0xAA: Opc('RES 5,D', 8, 2, mock),
    0xAB: Opc('RES 5,E', 8, 2, mock),
    0xAC: Opc('RES 5,H', 8, 2, mock),
    0xAD: Opc('RES 5,L', 8, 2, mock),
    0xAE: Opc('RES 5,(HL)', 16, 2, mock),
    0xAF: Opc('RES 5,A', 8, 2, mock),
    0xB0: Opc('RES 6,B', 8, 2, mock),
    0xB1: Opc('RES 6,C', 8, 2, mock),
    0xB2: Opc('RES 6,D', 8, 2, mock),
    0xB3: Opc('RES 6,E', 8, 2, mock),
    0xB4: Opc('RES 6,H', 8, 2, mock),
    0xB5: Opc('RES 6,L', 8, 2, mock),
    0xB6: Opc('RES 6,(HL)', 16, 2, mock),
    0xB7: Opc('RES 6,A', 8, 2, mock),
    0xB8: Opc('RES 7,B', 8, 2, mock),
    0xB9: Opc('RES 7,C', 8, 2, mock),
    0xBA: Opc('RES 7,D', 8, 2, mock),
    0xBB: Opc('RES 7,E', 8, 2, mock),
    0xBC: Opc('RES 7,H', 8, 2, mock),
    0xBD: Opc('RES 7,L', 8, 2, mock),
    0xBE: Opc('RES 7,(HL)', 16, 2, mock),
    0xBF: Opc('RES 7,A', 8, 2, mock),
    0xC0: Opc('SET 0,B', 8, 2, mock),
    0xC1: Opc('SET 0,C', 8, 2, mock),
    0xC2: Opc('SET 0,D', 8, 2, mock),
    0xC3: Opc('SET 0,E', 8, 2, mock),
    0xC4: Opc('SET 0,H', 8, 2, mock),
    0xC5: Opc('SET 0,L', 8, 2, mock),
    0xC6: Opc('SET 0,(HL)', 16, 2, mock),
    0xC7: Opc('SET 0,A', 8, 2, mock),
    0xC8: Opc('SET 1,B', 8, 2, mock),
    0xC9: Opc('SET 1,C', 8, 2, mock),
    0xCA: Opc('SET 1,D', 8, 2, mock),
    0xCB: Opc('SET 1,E', 8, 2, mock),
    0xCC: Opc('SET 1,H', 8, 2, mock),
    0xCD: Opc('SET 1,L', 8, 2, mock),
    0xCE: Opc('SET 1,(HL)', 16, 2, mock),
    0xCF: Opc('SET 1,A', 8, 2, mock),
    0xD0: Opc('SET 2,B', 8, 2, mock),
    0xD1: Opc('SET 2,C', 8, 2, mock),
    0xD2: Opc('SET 2,D', 8, 2, mock),
    0xD3: Opc('SET 2,E', 8, 2, mock),
    0xD4: Opc('SET 2,H', 8, 2, mock),
    0xD5: Opc('SET 2,L', 8, 2, mock),
    0xD6: Opc('SET 2,(HL)', 16, 2, mock),
    0xD7: Opc('SET 2,A', 8, 2, mock),
    0xD8: Opc('SET 3,B', 8, 2, mock),
    0xD9: Opc('SET 3,C', 8, 2, mock),
    0xDA: Opc('SET 3,D', 8, 2, mock),
    0xDB: Opc('SET 3,E', 8, 2, mock),
    0xDC: Opc('SET 3,H', 8, 2, mock),
    0xDD: Opc('SET 3,L', 8, 2, mock),
    0xDE: Opc('SET 3,(HL)', 16, 2, mock),
    0xDF: Opc('SET 3,A', 8, 2, mock),
    0xE0: Opc('SET 4,B', 8, 2, mock),
    0xE1: Opc('SET 4,C', 8, 2, mock),
    0xE2: Opc('SET 4,D', 8, 2, mock),
    0xE3: Opc('SET 4,E', 8, 2, mock),
    0xE4: Opc('SET 4,H', 8, 2, mock),
    0xE5: Opc('SET 4,L', 8, 2, mock),
    0xE6: Opc('SET 4,(HL)', 16, 2, mock),
    0xE7: Opc('SET 4,A', 8, 2, mock),
    0xE8: Opc('SET 5,B', 8, 2, mock),
    0xE9: Opc('SET 5,C', 8, 2, mock),
    0xEA: Opc('SET 5,D', 8, 2, mock),
    0xEB: Opc('SET 5,E', 8, 2, mock),
    0xEC: Opc('SET 5,H', 8, 2, mock),
    0xED: Opc('SET 5,L', 8, 2, mock),
    0xEE: Opc('SET 5,(HL)', 16, 2, mock),
    0xEF: Opc('SET 5,A', 8, 2, mock),
    0xF0: Opc('SET 6,B', 8, 2, mock),
    0xF1: Opc('SET 6,C', 8, 2, mock),
    0xF2: Opc('SET 6,D', 8, 2, mock),
    0xF3: Opc('SET 6,E', 8, 2, mock),
    0xF4: Opc('SET 6,H', 8, 2, mock),
    0xF5: Opc('SET 6,L', 8, 2, mock),
    0xF6: Opc('SET 6,(HL)', 16, 2, mock),
    0xF7: Opc('SET 6,A', 8, 2, mock),
    0xF8: Opc('SET 7,B', 8, 2, mock),
    0xF9: Opc('SET 7,C', 8, 2, mock),
    0xFA: Opc('SET 7,D', 8, 2, mock),
    0xFB: Opc('SET 7,E', 8, 2, mock),
    0xFC: Opc('SET 7,H', 8, 2, mock),
    0xFD: Opc('SET 7,L', 8, 2, mock),
    0xFE: Opc('SET 7,(HL)', 16, 2, mock),
    0xFF: Opc('SET 7,A', 8, 2, mock)
}